...
<body>
    <div style="color:black">
        ...
        <p>
            Se le notifica que usted ha sido agregado/a al siguiente proyecto de horas sociales
            <b> {{$details['user']->nombre}}, por parte del/la encargado/a de dicho proyecto.</b>
